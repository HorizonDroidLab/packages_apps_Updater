 ...
 */
package com.horizon.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.horizon.build_version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.horizon.build_type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "horizon.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "horizon.updater.uri";
